class DeviseCreateStores < ActiveRecord::Migration
  def change
    create_table(:stores) do |t|
      ...
      t.string   :name_responsible, default: "", null: false
      t.string   :cnpj
      t.string   :instagram
      t.string   :facebook
      t.string   :site
      t.string   :telephone, default: "", null: false
      t.integer  :count_canceled_purchases, default: 0, null: false
      t.integer  :count_confirmed_purchases, default: 0, null: false
